...
def compress(filename, Q):
    ...
    if(len(shape) == 3):
        print("color")
        compress_color(image, Q, filename)
    elif(len(shape) == 2):
        print("greyscale")
        compress_greyscale(image, Q, filename)


###############################################################################################################

def compress_greyscale(image, Q, filename):
    ...
    H_div_8 = H // 8  # Integer division
    W_div_8 = W // 8  # Integer division

    # Convert them to strings of size 10
    H_str = format(H_div_8, '010b')  # Format as a 10-digit string (padded with leading zeros)
    W_str = format(W_div_8, '010b')  # Format as a 10-digit string (padded with leading zeros)
...
def compress_color(image, Q, filename):
    return
